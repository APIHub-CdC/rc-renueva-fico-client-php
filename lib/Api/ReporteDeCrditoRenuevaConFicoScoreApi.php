...
namespace RcRenuevaFico\Client\Api;
...
use RcRenuevaFico\Client\HeaderSelector;
use RcRenuevaFico\Client\ObjectSerializer;

class ReporteDeCrditoRenuevaConFicoScoreApi
{
    ...
    {
        $returnType = '\RcRenuevaFico\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenuevaFico\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenuevaFico\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
