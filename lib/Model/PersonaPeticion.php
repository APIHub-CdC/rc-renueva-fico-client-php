...
class PersonaPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $RCCPMTypes = [
        ...
        'domicilio' => '\RcRenuevaFico\Client\Model\DomicilioPeticion',
        'cuenta' => 'string'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['cuenta']) > 40)) {
            $invalidProperties[] = "invalid value for 'cuenta', the character length must be smaller than or equal to 40.";
        }
    ...
    {
        if ((mb_strlen($cuenta) > 40)) {
            throw new \InvalidArgumentException('invalid length for $cuenta when calling PersonaPeticion., must be smaller than or equal to 40.');
        }
