...
class DomicilioRespuesta implements ModelInterface, ArrayAccess
{
    ...
    protected static $RCCPMModelName = 'DomicilioRespuesta';
    ...
    protected static $RCCPMTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\RcRenuevaFico\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\RcRenuevaFico\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\RcRenuevaFico\Client\Model\CatalogoTipoAsentamiento',
    ...
    public function setCp($cp)
    {
        if (!is_null($cp) && (mb_strlen($cp) > 5)) {
            throw new \InvalidArgumentException('invalid length for $cp when calling DomicilioRespuesta., must be smaller than or equal to 5.');
        }
