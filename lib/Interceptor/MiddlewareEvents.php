...
namespace RcRenuevaFicoClientPhp\Client\Interceptor;
...
use \RcRenuevaFicoClientPhp\Client\Interceptor\KeyHandler;
use \RcRenuevaFicoClientPhp\Client\Interceptor\MyLogger;
use \RcRenuevaFicoClientPhp\Client\Model\Errors;
use \RcRenuevaFicoClientPhp\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\RcRenuevaFicoClientPhp\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \RcRenuevaFicoClientPhp\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \RcRenuevaFicoClientPhp\Client\Model\Errores(["errors" => [$error]]);
