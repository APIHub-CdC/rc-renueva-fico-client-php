...
### Paso 4. Modificar URL y credenciales
 ...
 Modificar la URL y las credenciales de acceso a la petición en ***test/Api/ReporteDeCrditoRenuevaConFicoScoreApiTest.php***, como se muestra en el siguiente fragmento de código:

```php
public function setUp()
{
    $password = getenv('KEY_PASSWORD');
    this->keypair = 'Your Keypair';
    $this->cert = 'Your Cert';
